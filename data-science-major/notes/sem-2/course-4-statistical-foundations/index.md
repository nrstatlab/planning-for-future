---
layout: note
title: "Course 4 — Statistical Foundations for Data Science"
...
anyway; it is covered in [unit-1.md](unit-1.html). See
[`SYLLABUS-REVIEW.md`](../../../SYLLABUS-REVIEW.html) finding **D1**.
...
|:---:|---|---|---|:---:|
| 1 | Probability and basic statistics | [unit-1.md](unit-1.html) | Moderate | 3 |
| 2 | Random variables, expectation, variance | [unit-2.md](unit-2.html) | Moderate | 2 |
| 3 | Probability distributions | [unit-3.md](unit-3.html) | **Hard** | 3 |
| 4 | Correlation and regression | [unit-4.md](unit-4.html) | **Hard** | 3 |
| 5 | Inference and hypothesis testing | [unit-5.md](unit-5.html) | **Hard** | 3 |

Units 3, 4 and 5 carry the difficulty. They also carry the marks.

## Also here

- [formula-sheet.md](formula-sheet.html) — every formula in one place, for revision
- [practice.md](practice.html) — problems with full worked solutions
- [lab.md](lab.html) — all 15 experiments
