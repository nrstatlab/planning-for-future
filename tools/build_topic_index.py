...
# detex() lives in build_site.py with the other text rules, so the A-Z
# index, the search index and the meta descriptions all spell a symbol the
# same way. Imported rather than restated.
detex = _bs_mod.detex
