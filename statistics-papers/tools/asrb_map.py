#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build statistics-papers/asrb-net/index.html from the syllabus and the map data.
...
def render(units):
    ...
    a('<meta property="og:url" content="https://nrstatlab.github.io/planning-for-future/statistics-papers/asrb-net/index.html">\n')
    a('<link rel="stylesheet" href="../../statistics-major/msc/css/styles.css">\n')
    a('<link rel="canonical" href="https://nrstatlab.github.io/planning-for-future/statistics-papers/asrb-net/index.html">\n')
    a(STYLE)
    a(BAR_STYLE)
    a('</head>\n<body>\n')
    a(BAR)
