# -*- coding: utf-8 -*-
"""Render statistics-papers/appsc/ from appsc_map_data.py.
...
sys.path.insert(0, os.path.join(os.path.dirname(HERE), "iss"))
...
OUT = os.path.join(os.path.dirname(HERE), "appsc") + os.sep
labels.BASE = OUT
...
def post_page(key, other):
    ...
    if key == "AD":
        b.append('  <div class="note">\n    <p><strong>&ldquo;P. G. Standard&rdquo; does not '
                 ...
                 '<a href="../../statistics-major/msc/">MSc material</a> is not needed for it. '
