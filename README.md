...
| [`statistics-papers/`](statistics-papers/) | Examinations, one syllabus map each | ISS, UGC NET, CSIR NET and both APPSC posts built; SSC waiting on its notification |
