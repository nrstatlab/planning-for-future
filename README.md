...
| [`statistics-papers/`](statistics-papers/) | Examinations, one syllabus map each | ISS, UGC NET, CSIR NET, ASRB NET Agricultural Statistics and both APPSC posts built |
| [`exam-subjects/`](exam-subjects/) | Allied subjects these papers ask for | Economics and Financial Accounting, 6 units each |
