...
```bash
python3 tools/data-science/run_nlp_labs.py
```
...
scores an FAQ retriever. `tools/data-science/run_nlp_labs.py` asserts all three
...
python3 tools/data-science/fetch_nlp_data.py     # 17 NLTK corpora
python3 tools/data-science/run_nlp_labs.py
```
