...
| **The verification** | **14 programs** | **Executed and asserted** by `tools/data-science/run_bigdata_labs.py` |
...
bash tools/data-science/setup_spark.sh          # optional; experiment 17 needs it
python3 tools/data-science/run_bigdata_labs.py
```
